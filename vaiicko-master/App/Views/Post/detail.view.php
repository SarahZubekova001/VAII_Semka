...
<div class="container mt-4">
    <div class="text-center mt-1 mb-4">
        <a href="<?= htmlspecialchars($_SERVER['HTTP_REFERER'] ?? '/') ?>" class="btn btn-secondary">Späť</a>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            ...
            <?php if ($mainImage): ?>
                <img src="/public/uploads/<?= htmlspecialchars($mainImage->getPath()) ?>" alt="Hlavný obrázok" class="img-fluid rounded shadow">
            <?php else: ?>
        ...
        <div class="col-12">
            ...
            <div class="gallery row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <?php foreach ($data['post']->getGallery() as $galleryItem): ?>
                    <div class="col">
                        <img src="/public/uploads/<?= htmlspecialchars($galleryItem->getPath()) ?>" alt="Obrázok" class="img-fluid rounded shadow">
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
